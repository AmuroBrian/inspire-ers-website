        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-6">
              <a
                href="/"
                className="text-white hover:text-orange-400 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 flex items-center drop-shadow-lg"
              >
                HOME
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white bg-opacity-95 rounded-b-lg backdrop-blur-md border border-gray-200 shadow-lg">
              <a
                href="#"
                className="text-gray-800 hover:text-orange-500 block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200"
              >
                HOME
              </a>
              <a
